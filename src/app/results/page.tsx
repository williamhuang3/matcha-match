  ...
  return (
    <main className="max-w-3xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-white rounded-xl p-4 shadow space-y-4">
        ...
        <div className="mt-6">
          <h3 className="text-xl font-semibold text-matcha-taupe">Your Matcha Region: {regionInfo.region}</h3>
          <img src={regionInfo.img} alt={regionInfo.region} className="w-full rounded-lg mt-2" />
      ...
      <div className="bg-matcha-offwhite p-4 rounded-lg">
        <p className="text-matcha-taupe mb-1"><strong>Experience:</strong> {parsed.experience}</p>
        <p className="text-matcha-taupe mb-1"><strong>Usage:</strong> {parsed.usage.join(", ")}</p>
        <p className="text-matcha-taupe"><strong>Ideal Price:</strong> ${parsed.price}</p>
      </div>

      <div className="mt-8">
        <h2 className="text-2xl font-semibold text-matcha-taupe mb-4">Top 3 Matches</h2>
